...
function handleRequest(req, res) {
  ...
  parse_post(req, function(data) {
    ...
    var signature = crypto.createHmac('sha256', 'd39f390c4c583e9ffd7f41b3b4904084').update(data[1]).digest('base64').replace(/\+/g, '-').replace(/\//g, '_').replace('=', '');
    ...
    if (!facebook.user_id) {
      ...
      var url = 'http://www.facebook.com/dialog/oauth?client_id=159045587614731&redirect_uri=http://apps.facebook.com/nodeexample/&scope=user_about_me';
      ...
      fs.readFile('header.html', function(err, data) {
        ...
        var tokencrypt = crypto.createCipher('des-ecb', 'd46s784c4c583e9ffd7f41b3b4904084');
